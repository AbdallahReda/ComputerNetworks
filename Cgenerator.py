class generator:
    def __init__(self,message,generator):
        self.message=message
        self.generator=generator
        


    def generate(self):    #Generator function which takes message and gen as paramters, performing crc algorithm  
         
        frame = self.message             # Make frame = message  
        gen=self.generator                           #then return the transmitted message and the remndr of divison operation
                     # Make frame = message  
